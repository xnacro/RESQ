...
export const LOCALITY_GAZETTEER = Object.freeze([
  ...
  { name: "Agthori", state: "Assam", district: "Kamrup", lat: 26.1986, lon: 91.6860 },
  { name: "Amingaon", state: "Assam", district: "Kamrup", lat: 26.1833, lon: 91.6833 },
  { name: "North Guwahati", state: "Assam", district: "Kamrup", lat: 26.2000, lon: 91.7167 },
  { name: "Maligaon", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1550, lon: 91.6980 },
  { name: "Jalukbari", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1480, lon: 91.6640 },
  { name: "Khanapara", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1150, lon: 91.8200 },
  { name: "Beltola", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1280, lon: 91.7920 },
  { name: "Paltan Bazaar", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1800, lon: 91.7500 },
  { name: "Panbazar", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1880, lon: 91.7480 },
  { name: "Chandmari", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1860, lon: 91.7740 },
  { name: "Ganeshguri", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1500, lon: 91.7850 },
  { name: "Six Mile", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1360, lon: 91.8080 },
  { name: "Borjhar", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1060, lon: 91.5860 },
  { name: "Kamakhya", state: "Assam", district: "Kamrup Metropolitan", lat: 26.1660, lon: 91.7060 },
